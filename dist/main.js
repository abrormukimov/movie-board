...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _myapi_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./myapi.js */ \"./src/myapi.js\");\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module './icon.svg'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module './logo.svg'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module './Like.svg'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\n/* harmony import */ var _generate_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./generate.js */ \"./src/generate.js\");\n/* harmony import */ var _likes_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./likes.js */ \"./src/likes.js\");\n\n\n\n\n\n\n\n\nconst header = (0,_generate_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])('header');\nconst logo = (0,_generate_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])('img', 'logo');\nlogo.src = Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './logo.svg'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\nlogo.alt = 'restaurant-logo';\nconst navigation = (0,_generate_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])('nav');\nconst uList = (0,_generate_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])('ul');\nconst listOne = (0,_generate_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])('li', 'meals');\nconst linkOne = (0,_generate_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])('a');\nlinkOne.href = '#';\n\nfunction mealCounter() {\n  fetch('https://www.themealdb.com/api/json/v1/1/filter.php?c=chicken')\n    .then((response) => response.json())\n    .then((data) => {\n      linkOne.textContent = `Meals (${data.meals.length})`;\n    });\n}\nmealCounter();\n\nconst listTwo = (0,_generate_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])('li');\nconst linkTwo = (0,_generate_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])('a');\nlinkTwo.href = '#';\nlinkTwo.textContent = 'non-Vegetarian';\n\nconst listThree = (0,_generate_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])('li');\nconst linkThree = (0,_generate_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])('a');\nlinkThree.href = '#';\nlinkThree.textContent = 'fried';\n\nconst footer = (0,_generate_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])('footer');\nfooter.textContent = 'Created By Tufoin & Abror under CC licence';\n\nconst allmain = document.getElementById('allmain');\n\nconst main = (0,_generate_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])('main');\n\nconst createPopup = (meal) => {\n  const popupSection = (0,_generate_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])('section', 'popup-window invisible');\n  const popupMarkup = ` \n    <small class='close-menu'>X</small>   \n    <div class='blur-background'> \n\n    <div class=\"popup-img-div\"><img class=\"meal-popup-img\" src=\"${meal.image}\" alt=\"meal\" /></div>\n    <div class=\"popup-details-div\">\n    <h1> ${meal.title} </h1>\n    <div class=\"details-list\">\n        <ul>\n        <li>Category: Rice</li>\n        <li>Category: Rice</li>\n        </ul>\n        <ul>\n        <li>Category: Rice</li>\n        <li>Category: Rice</li>\n        </ul>\n    </div>\n  </div>\n  <div class=\"comments-container\">\n<div class=\"comments-div\">\n  <h3>Comments (3)</h3>\n</div>\n<h3>Add a comment</h3>\n<form>\n  <div class=\"input-group\">\n    <input type=\"text\" class=\"nameInput\" placeholder=\"Your name\" />\n  </div>\n  <div class=\"input-group\">\n    <textarea\n      name=\"\"\n      id=\"commentInput\"\n      cols=\"30\"\n      rows=\"10\"\n      placeholder=\"Your insights\"\n    ></textarea>\n  </div>\n  <div class=''button-div>\n  <button type='submit' class='submit-comment-btn'> Comment </button>\n  </div>\n</form>\n</div>\n`;\n  popupSection.innerHTML = popupMarkup;\n  popupSection.style.display = 'block';\n  main.style.display = 'none';\n  document.body.appendChild(popupSection);\n  const closePopup = document.querySelector('.close-menu');\n  closePopup.addEventListener('click', () => {\n    popupSection.remove();\n    main.style.display = 'grid';\n  });\n};\n\nconst displayPopup = (mainTag) => {\n  const divs = mainTag.children;\n  const mealDetails = {\n    title: '',\n    category: '',\n    price: '',\n    image: '',\n  };\n\n  for (let i = 0; i < divs.length; i += 1) {\n    const btn = divs[i].children[2];\n    btn.addEventListener('click', (e) => {\n      const mealTitle = e.target.parentElement.children[1].children[0].textContent;\n      const imageSrc = e.target.parentElement.children[0].src;\n      mealDetails.title = mealTitle;\n      mealDetails.image = imageSrc;\n      createPopup(mealDetails);\n    });\n  }\n};\n\nconst getMeals = async () => {\n  const data = await (0,_myapi_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n  data.meals.forEach((meal, index) => {\n    meal = (0,_generate_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])('section');\n    const picture = (0,_generate_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])('img', 'image');\n    picture.src = data.meals[index].strMealThumb;\n    picture.alt = 'space-image';\n\n    meal.id = data.meals[index].idMeal;\n\n    const likes = (0,_generate_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])('div', 'likes');\n    const paragraph = (0,_generate_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])('p');\n    paragraph.textContent = data.meals[index].strMeal;\n\n    const likeCounter = (0,_generate_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])('div', 'like-counter');\n    const heart = (0,_generate_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])('img', 'heart');\n    heart.src = Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './Like.svg'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\n    heart.alt = 'heart-image';\n    const like = (0,_generate_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])('p');\n    like.textContent = '0 likes';\n\n    heart.addEventListener('click', async (e) => {\n      e.preventDefault();\n      (0,_likes_js__WEBPACK_IMPORTED_MODULE_4__.postLikes)(\n        'https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/apps/Q6UlXEVzMxLrY3bfiZ0o/likes/',\n        {\n          item_id: meal.id,\n        },\n      );\n\n      const prevLikes = like.textContent.split(' ')[0];\n      like.innerHTML = `${parseInt(prevLikes, 10) + 1} likes`;\n    });\n\n    const likes1 = (0,_likes_js__WEBPACK_IMPORTED_MODULE_4__.getLikes)(\n      'https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/apps/Q6UlXEVzMxLrY3bfiZ0o/likes/',\n    );\n\n    likes1.then((data) => {\n      like.textContent = `${data[index].likes} likes`;\n    });\n\n    likeCounter.appendChild(heart);\n    likeCounter.appendChild(like);\n\n    likes.appendChild(paragraph);\n    likes.appendChild(likeCounter);\n\n    const comments = (0,_generate_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])('button');\n    comments.textContent = 'Comments';\n\n    meal.appendChild(picture);\n    meal.appendChild(likes);\n    meal.appendChild(comments);\n\n    main.appendChild(meal);\n  });\n  displayPopup(main);\n};\ngetMeals();\n\nlistOne.appendChild(linkOne);\nlistTwo.appendChild(linkTwo);\nlistThree.appendChild(linkThree);\n\nuList.append(listOne, listTwo, listThree);\nnavigation.appendChild(uList);\nheader.append(logo, navigation);\nallmain.append(header, main, footer);\n\n\n//# sourceURL=webpack://webpack-demo/./src/index.js?");
